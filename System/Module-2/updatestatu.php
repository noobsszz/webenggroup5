<?php
    ...
    $id=$_GET['updateid'];
    $sql="SELECT `status` FROM `inffo` WHERE id=$id";
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="UPDATE `inffo` SET `id`='$id',`status`='$status' WHERE id=$id";
        $result=mysqli_query($con,$sql);
        if($result){
            ...
            <div id="page-content-wrapper">
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="radio" class="form-check-input" name="status" value="Available">Assigned
